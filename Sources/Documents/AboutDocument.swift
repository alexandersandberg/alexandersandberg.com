...
let aboutDocument = Document(.html) {
	...
	Section(title: "What") {
		Div {
			...
			P(#"I work full-time as a Senior Mobile Engineer at <a href="https://www.sofi.com">SoFi</a> on the Invest team."#)
...
let work = [
	LinkedResource(
		...
		description: "Senior Mobile Engineer ⋅ 2026–Now"
	),
	LinkedResource(
		title: "Self-employed",
		href: "/apps/",
		description: "Indie App Developer ⋅ 2020–Now"
	),
	LinkedResource(
		title: "Composer",
		href: "https://composer.trade",
		description: "Lead iOS Engineer ⋅ 2023–2026"
	),
	LinkedResource(
